...
namespace Hakuu.Ui
{
    public partial class Ui : Form
    {
        ...
        private void SettingServerAutoStop_MouseHover(object sender, EventArgs e)
            => ShowToolTip(sender, "Hakuu发生崩溃时，若服务器正在运行则自动关闭服务器（建议开启）");
        ...
        private void SettingHakuuAutoUpdate_MouseHover(object sender, System.EventArgs e)
            => ShowToolTip(sender, "Hakuu关闭后自动替换新版本");
        private void SettingHakuuEnableGetUpdate_MouseHover(object sender, EventArgs e)
            => ShowToolTip(sender, "启动后自动获取更新（建议开启）");
        private void SettingHakuuAbout_MouseHover(object sender, EventArgs e)
            => ShowToolTip(sender, "https://Hakuu.cc/docs/more/about");
        private void SettingHakuuPage_MouseHover(object sender, EventArgs e)
            => ShowToolTip(sender, "https://Hakuu.cc");
        private void SettingHakuuExtension_MouseHover(object sender, EventArgs e)
            => ShowToolTip(sender, "https://market.Hakuu.cc");
        private void SettingHakuuDownload_MouseHover(object sender, EventArgs e)
            => ShowToolTip(sender, "https://github.com/Zaitonn/Hakuu/releases/latest");
        private void SettingHakuuEnableDPIAware_MouseHover(object sender, EventArgs e)
