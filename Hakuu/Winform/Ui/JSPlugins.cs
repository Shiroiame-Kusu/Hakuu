...
namespace Hakuu.Ui
{
    public partial class Ui : Form
    {
        ...
        private void JSPluginListContextMenuStrip_Docs_Click(object sender, EventArgs e) => Process.Start(new ProcessStartInfo("https://Hakuu.cc/docs/development/intro") { UseShellExecute = true });
    }
}
