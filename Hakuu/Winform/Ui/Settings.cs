...
namespace Hakuu.Ui
{
    public partial class Ui : Form
    {
        public void LoadSettings()
        {
            ...
            SettingHakuuEnableGetUpdate.Checked = Global.Settings.Hakuu.EnableGetUpdate;
            SettingHakuuAutoUpdate.Checked = Global.Settings.Hakuu.AutoUpdate;
            SettingHakuuAutoUpdate.Enabled = SettingHakuuEnableGetUpdate.Checked;
            SettingHakuuEnableDPIAware.Checked = Global.Settings.Hakuu.DPIAware;
            if (!Global.Settings.Hakuu.DevelopmentTool.EnableDebug)
            {
                Debug.Parent = null;
            }
            ServerPanel.Parent = Global.Settings.Hakuu.PagesDisplayed.ServerPanel ? ServerPanel.Parent : null;
            ServerPluginManager.Parent = Global.Settings.Hakuu.PagesDisplayed.ServerPluginManager ? ServerPluginManager.Parent : null;
            Regular.Parent = Global.Settings.Hakuu.PagesDisplayed.RegexList ? Regular.Parent : null;
            Schedule.Parent = Global.Settings.Hakuu.PagesDisplayed.Schedule ? Schedule.Parent : null;
            Bot.Parent = Global.Settings.Hakuu.PagesDisplayed.Bot ? Bot.Parent : null;
            JSPlugin.Parent = Global.Settings.Hakuu.PagesDisplayed.JSPlugin ? JSPlugin.Parent : null;
            Member.Parent = Global.Settings.Hakuu.PagesDisplayed.Member ? Member.Parent : null;
            Setting.Parent = Global.Settings.Hakuu.PagesDisplayed.Settings ? Setting.Parent : null;
        }
        ...
        #endregion
        #region Hakuu
        private void SettingHakuuEnableGetUpdate_Click(object sender, EventArgs e)
        {
            Global.Settings.Hakuu.EnableGetUpdate = SettingHakuuEnableGetUpdate.Checked;
            SettingHakuuAutoUpdate.Checked = SettingHakuuEnableGetUpdate.Checked ? SettingHakuuAutoUpdate.Checked : false;
            SettingHakuuAutoUpdate.Enabled = SettingHakuuEnableGetUpdate.Checked;
            Global.Settings.Hakuu.AutoUpdate = SettingHakuuAutoUpdate.Checked;
        }
        private void SettingHakuuAutoUpdate_Click(object sender, EventArgs e)
            => Global.Settings.Hakuu.AutoUpdate = SettingHakuuAutoUpdate.Checked;
        private void SettingHakuuAbout_Click(object sender, EventArgs e)
            => Process.Start(new ProcessStartInfo("https://Hakuu.cc/docs/more/about") { UseShellExecute = true });
        private void SettingHakuuPage_Click(object sender, EventArgs e)
            => Process.Start(new ProcessStartInfo("https://Hakuu.cc") { UseShellExecute = true });
        private void SettingHakuuExtension_Click(object sender, EventArgs e)
            => Process.Start(new ProcessStartInfo("https://market.Hakuu.cc") { UseShellExecute = true });
        private void SettingHakuuDownload_Click(object sender, EventArgs e)
            => Process.Start(new ProcessStartInfo("https://github.com/Zaitonn/Hakuu/releases/latest") { UseShellExecute = true });
        private void SettingEventListContextMenuStrip_Docs_Click(object sender, EventArgs e)
            => Process.Start(new ProcessStartInfo("https://Hakuu.cc/docs/guide/event") { UseShellExecute = true });
        private void SettingHakuuEnableDPIAware_CheckedChanged(object sender, EventArgs e)
            => Global.Settings.Hakuu.DPIAware = SettingHakuuEnableDPIAware.Checked;
        ...
        private void SettingHakuuVersion_Click(object sender, EventArgs _)
        {
            Ookii.Dialogs.Wpf.TaskDialog taskDialog = new()
            {
                ...
                Footer = "开源地址：<a href=\"https://github.com/Zaitonn/Hakuu\">GitHub</a>",
