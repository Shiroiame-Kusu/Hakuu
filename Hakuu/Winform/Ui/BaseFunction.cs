...
namespace Hakuu.Ui
{
    public partial class Ui : Form
    {
        ...
        private void SettingHakuuShowWelcomePage_Click(object sender, EventArgs e)
        ...
        private void Ui_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                HakuuIcon.Dispose();
                JSFunc.Trigger(Base.EventType.HakuuClose);
            }
        }

        public void ShowBalloonTip(string text)
        {
            HakuuIcon.BalloonTipTitle = "Hakuu";
            HakuuIcon.BalloonTipText = text;
            HakuuIcon.ShowBalloonTip(10000);
        }
        ...
        {
            SettingHakuuVersion.Text = $"当前版本：{Global.VERSION}";
        ...
        private void HakuuIcon_BalloonTipClicked(object sender, EventArgs e) => FocusWindow();
        private void HakuuIcon_MouseClick(object sender, MouseEventArgs e) => FocusWindow();
