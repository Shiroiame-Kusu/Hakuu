    ...
    public partial class RegexEditor : Form
    {
        ...
        private void Confirm_Click(object sender, EventArgs e)
        {
                ...
                ))
            {
                ...
                {
                    MessageBox.Show("正则表达式无效", "Hakuu", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            else
            {
        ...
        {
            Process.Start(new ProcessStartInfo("https://Hakuu.cc/docs/guide/regex") { UseShellExecute = true });
        }
    }
}
