...
namespace Hakuu.Ui
{
    public partial class Ui : Form
    {
        ...
        private void RegexContextMenuStrip_Variables_Click(object sender, EventArgs e) => Process.Start(new ProcessStartInfo("https://Hakuu.cc/docs/guide/variables") { UseShellExecute = true });
        private void RegexContextMenuStrip_Command_Click(object sender, EventArgs e) => Process.Start(new ProcessStartInfo("https://Hakuu.cc/docs/guide/command") { UseShellExecute = true });
    }
}
