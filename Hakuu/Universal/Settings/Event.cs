...
namespace Hakuu.Settings
{
    ...
    {
        public static string Notice { get; } = "在这里你可以自定义每个事件触发时执行的命令。参考：https://Hakuu.cc/docs/guide/command、https://Hakuu.cc/docs/guide/event";
        ...
        public string[] HakuuCrash { get; set; } = new[]
        {
            "g|唔……发生了一点小问题(っ °Д °;)っ\n请查看Hakuu错误弹窗获取更多信息"
        };
        ...
        public string[] Get(EventType type)
            => type switch
            {
                ...
                EventType.HakuuCrash => HakuuCrash,
